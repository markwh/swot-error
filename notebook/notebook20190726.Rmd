...
foo <- intermed2pixc(classnc_ss2, varid = "classification", 
                     pixcdf = pixcdf, outname = "class_inter")
...
wfracdf %>% 
  sample_n(300) %>% 
  ggplot(aes(x = sigalpha_o, y = water_frac_uncert)) +
...
wfracdf %>% 
  sample_n(300) %>% 
  ggplot(aes(x = sigalpha_s, y = sigalpha_i)) +
  geom_point()
```
